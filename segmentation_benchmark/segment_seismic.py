# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/segment_seismic.ipynb.

# %% auto 0
__all__ = ['train_test_split', 'train', 'test', 'run']

# %% ../nbs/segment_seismic.ipynb 2
import sys
